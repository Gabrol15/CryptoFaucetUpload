...
<div class="login-section" data-aos="zoom-in" data-aos-delay="100">
  <div class="login-form">
    <div class="login-header">
      <h2>Register to <?= $settings['name'] ?></h2>
      <p>And earn free cryptocurrency with us</p>
    </div>
    <div class="form">
    <form id="regform" action="<?= site_url('auth/register') ?>" autocomplete="on" method="POST">
    <input type="hidden" name="<?= $csrf_name ?>" value="<?= $csrf_hash ?>">
      ...
      <div class="input-field">
        ...
        <input type="text" name="username" class="form-control" id="username" placeholder="Enter username" pattern="^[a-zA-Z]{1,1}[a-zA-Z0-9_]{2,13}[a-zA-Z0-9]{1,1}$" title="Username should only contain lowercase letters, numbers and _. e.g. mrqrama_1234" required>
      </div>
       <div class="input-field">
    ...
    <button onclick="document.getElementById('regform').submit();" type="submit" class="btn btn-primary btn-block">Register</button>
